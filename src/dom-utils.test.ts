...
// The sanitizer's own tests live in `tosijs-kilpi`, with DOMPurify's 223-fixture
// corpus as its gate. Duplicating them here would recreate exactly the
// two-copies problem the extraction removed — including the risk of the copies
